...
const { Fake } = require('../internal/mocks/type')
...
tap.test('either errors', t => {
  ...
  t.throws(
    () => either(onError)(onSuccess)(Fake(10)),
    {},
...
tap.test('fromLeft errors', t => {
  t.throws(
    () => fromLeft('fallback message')(Fake(10)),
    {},
...
tap.test('fromRight errors', t => {
  t.throws(
    () => fromRight('fallback message')(Fake(10)),
    {},
...
tap.test('partitionEithers errors', t => {
  const ms = [Left(1), false, Right(2), Left(3), Right(4)]
